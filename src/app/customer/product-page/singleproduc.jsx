...
import { getProductById } from '../../../server/admin-api';
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between">
                ...
                <button className="btn btn-ghost btn-sm" aria-label="Share product">
                  <Share2 size={20} />
                </button>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <button
                  ...
                  className="btn bg-black text-white hover:bg-gray-800 flex-1"
                >
                  Add to Cart
                </button>
              </div>
